...
/*----------------------------------------------------------------
  ...
  see http://www.nicolashoening.de?PolyPager
  ----------------------------------------------------------------*/
...
function submit_form_by_selection(command) {
	agree = confirm('<?=__('a change this field is important for other fields in this form. I therefore suggest a quick reload.')?>');
	if (agree) {
